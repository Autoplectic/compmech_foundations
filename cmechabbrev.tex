...
\newcommand{\Process}{\mathcal{P}\xspace}

\newcommand{\ProbMach}{\Prob_{\mathrm{M}}}
\newcommand{\Lmax}   { {L_{\mathrm{max}}}}
\newcommand{\MeasAlphabet}      {\mathcal{A}\xspace}
% Original symbol
...
% ******************************************************************************
% Metric quantities of information generation:
...
\renewcommand{\Process} {\ensuremath{\mathcal{P}}\xspace}

\renewcommand{\eT} {$\acute{\epsilon}$tomata\xspace}

\renewcommand{\MeasAlphabet} {\ensuremath{\Sigma}\xspace}
