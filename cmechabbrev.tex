...
\newcommand{\eM}     {\mbox{$\epsilon$-machine}\xspace}
\newcommand{\eMs}    {\mbox{$\epsilon$-machines}\xspace}
\newcommand{\EM}     {\mbox{$\epsilon$-Machine}\xspace}
\newcommand{\EMs}    {\mbox{$\epsilon$-Machines}\xspace}
\newcommand{\eT}     {\mbox{$\epsilon$-transducer}\xspace}
\newcommand{\eTs}    {\mbox{$\epsilon$-transducers}\xspace}
\newcommand{\ET}     {\mbox{$\epsilon$-Transducer}\xspace}
\newcommand{\ETs}    {\mbox{$\epsilon$-Transducers}\xspace}
...
\newcommand{\Process}{\ensuremath{\mathcal{P}}}

\newcommand{\ProbMach}{\Prob_{\mathrm{M}}}
\newcommand{\Lmax}   { {L_{\mathrm{max}}}}
\newcommand{\MeasAlphabet}      {\ensuremath{\mathcal{A}}}
% Original symbol
...
\newcommand{\GI}{\ensuremath{\varphi}\xspace}
\newcommand{\OI}{\ensuremath{\zeta}\xspace}
% cryptic, gauge, oracular, Markov, and synchronization
\newcommand{\COrder}{\ensuremath{k_{\PC}}\xspace}
\newcommand{\GOrder}{\ensuremath{k_{\GI}}\xspace}
\newcommand{\OOrder}{\ensuremath{k_{\OI}}\xspace}
\newcommand{\MOrder}{\ensuremath{R}\xspace}
\newcommand{\SOrder}{\ensuremath{k_{\SI}}\xspace}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Metric quantities of information generation, eg anatomy of a bit

\newcommand{\metric}[1] {\ensuremath{#1_\mu}\xspace}

\renewcommand{\hmu}{\metric{h}}
...
\newcommand{\pee}{\ensuremath{pee}\xspace} % parallel edge entropy

\newcommand{\ExE}[1] {\ensuremath{\EE_{#1}}\xspace}

\newcommand{\EER}{\ExE{R}}
\newcommand{\EEB}{\ExE{B}}
\newcommand{\EEQ}{\ExE{Q}}
\newcommand{\EEW}{\ExE{W}}
\newcommand{\EI}{\mathbf{I}}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Time series, using the python-esque notation

\newcommand{\MS} [2] {\ensuremath{\MeasSymbol_{#1:#2}}\xspace}
\newcommand{\ms} [2] {\ensuremath{\meassymbol_{#1:#2}}\xspace}

\renewcommand{\Past}       {\MS{}{0}}
\newcommand{\Present}      {\ensuremath{\MeasSymbol_{0}}\xspace}
\renewcommand{\Future}     {\MS{0}{}}
\newcommand{\LPresent} [1] {\MS{0}{#1}}
\newcommand{\LFuture}  [1] {\MS{#1}{}}
...
\newcommand{\FCS}{\CausalState^\forward\xspace}
\newcommand{\RCS}{\CausalState^\reverse\xspace}
...
\newcommand{\Lsync} {\Language_{\mathrm{sync}}\xspace}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mathclap, in case someone doesn't have mathtools
