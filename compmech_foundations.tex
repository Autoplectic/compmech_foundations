...
*define ``Reverse'' formally in terms of the limiting set of word probabilities for the reverse words at each length, prove that that coincides with just switching arrows of a presentation
